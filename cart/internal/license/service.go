...
type Service interface {
	...
	InsertNewLicenseList(userId uuid.UUID, data []entities.License) ([]entities.License, error)
...
func (s *service) InsertNewLicenseList(userId uuid.UUID, licenses []entities.License) ([]entities.License, error) {
	templateIds := []uint{}
	...
	licenses, err := s.repository.CreateNewLicenseList(userId, licenses)
	if err != nil {
		return []entities.License{}, err
	}
	return licenses, nil
