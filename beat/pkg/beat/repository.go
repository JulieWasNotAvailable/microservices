...
type Repository interface {
	...
	// //admin
	// DeleteBeatById(id uuid.UUID) (*presenters.Beat, error)
}
...
func (r *repository) ReadBeatById(id uuid.UUID) (*presenters.Beat, error) {
	...
	result := r.DB.Model(&beatModel).Preload("AvailableFiles").Preload("Tags").Preload("Genres").
		Preload("Moods").Preload("Timestamps").Preload("MFCC").Preload("Instruments").
